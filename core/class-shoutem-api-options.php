...
class ShoutemApiOptions {
	...
	var $shoutem_options_name = "mobile_app_api_options";
	...
	public function admin_menu() {
		add_options_page('Mobile App API Settings', 'Mobile App API', 'manage_options', 'mobile-app-api', array(&$this, 'admin_options'));
	}
	...
	public function admin_options() {
		...
		$ngg_integration = array(
				...
				'integration_desc' => __('Allows you to import NextGEN galleries in to your mobile application'),
		...
		$flagallery_integration = array(
				...
				'integration_desc' => __('Allows you to import GRAND FlAGallery galleries in to your mobile application'),
		...
		$podpress_integration = array(
				...
				'integration_desc' => __('Allows you to import podcasts into your mobile application'),
		...
		$powerpress_integration = array(
				...
				'integration_desc' => __('Show podcasts in posts on your mobile application'),
		...
		$viper_integration = array(
				...
				'integration_desc' => __('Show videos in posts on your mobile application'),
		...
		$em_integration = array(
				...
				'integration_desc' => __('Allows you to import events into your mobile application'),
	...
	private function print_options_page($options, $plugin_integrations) {
		...
		?>
			<div class="wrap">
  				...
  				<h2><?php _e('Mobile App API Settings') ?></h2>
    			...
    			<form action="options-general.php?page=mobile-app-api" method="post">
    				<?php wp_nonce_field('update-options'); ?>
    				<table class="form-table">
      					<tr valign="top">
        				<th scope="row"><?php _e('Mobile App Builder api encryption key') ?></th>
    			...
    			<div class="clear"></div>
    			<h4><?php _e('Mobile App API automatically integrates with the following plugins:') ?></h4>
    			<table class="widefat">
    				<thead>
    					<tr>
